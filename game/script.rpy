...
label location2:
    ...
    menu:
        ...
        'Проявить смелость':
            ...
            'Темнота и страх всеми силами пытается уберечь героя от некого в глубине норы. Добравшись на ватных ногах, игнорируя голоса рассудка, 
            ...
            будто еще секунду и покинет орбиту век, одна из щек попросту отсутствует, оголяя блестящее на просветах кровью мясо.'
            show augusta idle
            '[ggname] с недопониманием и ужасом пятится назад, жалея о своем решении прийти, пока это нечто пялится в пустоту 
            (как казалось герою, чтобы отыскать его, напасть и сожрать) и расчесывает кривыми когтями и без того уродливые раны.'
            u '...'
            ...
            '[ggname] бежит все дальше и путь прерывает удар лицом о что-то широкое, теплое. Похоже на мягкий зефир, или... 
        ...
        'Глаза нервно забегали из стороны в сторону. Теперь оба услышали громкие шаги и рык, доносящиеся неподалеку. Как же страшно...'
                ...
                menu:
                    'Биться с монстром': 
                        ...
                        'Он с хрипом выдыхает волну горяченного спертого воздуха и жмурит слепые очи. Взмахивает хвостом и уступает первый удар парочке… стало быть, заскучал уже в этой пещере.
                        ...
                        'Ударить в нос ': 
                            ...
                            Воспользовавшись моментом, бьет во всей силы по носу противника и заставляет оцепенеть. Пока он замахивался, Августа кидает в висок исполина камень…'
