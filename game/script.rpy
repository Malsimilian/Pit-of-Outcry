...
label lonely_rooms:
    ...
    menu:
        ...
        'Заговорить':
            ...
            gg 'Не хочешь, чтобы я помог тебе найти выход отсюда? Мне кажется, тебе здесь не место.'
            ...
            'Однако прерывает это действие вошедший ребенок небольшого роста. Бледный, измотанный.'
...
label fight:
    ...
    menu: 
        ...
        'Ударить в нос ': 
            ...
            '[ggname] и Августа несутся дальше во тьму и находят второй выход.'
...
label fight_frode_child: 
    ...
    menu: 
        ...
        'Ударить в глаз': 
            ...
            'Августа следует примеру. Слепой монстр убегает в глубины подземелья.'
...
label fight_child: 
    ...
    '[ggname] и Августа несутся дальше во тьму и находят второй выход. Однако ребенок не дает им выйти.'
    ...
    ch 'ВОЛК СЛАБ. СЛИШКОМ СЛАБ И МНОГОСЛОВЕН.'

    ch '{color=#ff0f0f} МНЕ ТАК НЕ ХОТЕЛОСЬ РАЗБИРАТЬСЯ САМОСТОЯТЕЛЬНО, НО ЭТУ ГНИЛЬ ДАЖЕ НЕ НАВЛЕЧЬ НА НОРМАЛЬНУЮ ОХОТУ.{/color}'
  
    'Концовка "МЫШИНЫЙ ВОЙ (Vol2)"'
