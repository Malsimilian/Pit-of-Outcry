...
label dark_corridors:
    play music "bridge" fadeout 1 
    queue music "codex" fadeout 1
...
label lonely_rooms:
    play music "friendly_ghost" fadeout 1
    play music "jaan" fadeout 1
    ...
    'Вырывается из уст вместе с нервным глотком кома в горле под конец. Существо улыбается гораздо шире, проявляются мимические морщины...'
            
    menu:
        'Спешно уйти от шизоидной':
            play music "salakapakka" fadeout 1
