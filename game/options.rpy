...
define config.name = _("Pit Of Outcry")
...
Отдельное спасибо imperator_kukisch за соавторство в сценарии. 

Сделано с помощью Ren`Py и Visual Studio Code. 

Музыка взята с общедоступных сайтов: https://uppbeat.io, 
https://zvukipro.com, https://elements.envato.com. 
...
# define config.main_menu_music = "audio/ave_maria.mp3"
...
define config.save_directory = "Test1-1718141188"
