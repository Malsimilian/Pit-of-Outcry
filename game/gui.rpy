...
define gui.muted_color = '#d19c9c'
define gui.hover_muted_color = '#d8a2a2'

## Цвета, используемые в тексте диалогов и выборов.
define gui.text_color = '#fddede'
define gui.interface_text_color = '#ffdcdc'


## Шрифты и их размеры #########################################################

## Шрифт, используемый внутриигровым текстом.
define gui.text_font = "Uncage_Regular.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "DejaVuSans.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "Uncage_Regular.ttf"
...
define gui.choice_button_text_idle_color = '#460e0e'
define gui.choice_button_text_hover_color = "#aa2222"
